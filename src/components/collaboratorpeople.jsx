...
import { colaborate,getList } from '../service/service';
...
export default function AddCollaborator(props) {
  ...
  const addCollaborator = (noteid) => {
    colaborate( collaborator,noteid)
      .then(response => {
      ...
      >
        <Card style={{ width: "620px" }} onClick={() => collaboratorList()}>
          ...
          {collaboaratorlist.map(o =>
            <div>
              ...
              <ListItem  >
                ...
                <ListItemText> {o.newemail}</ListItemText>
              </ListItem>
            </div>
          ...
          <ListItem>
            ...
            <TextField name="newemail" placeholder="enter emailId" name="collaborator" onChange={e => setCollaborator(e.target.value)} ></TextField>
          </ListItem>
        </Card>
